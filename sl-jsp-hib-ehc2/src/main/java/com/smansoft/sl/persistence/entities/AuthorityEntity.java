...
@NamedQueries({
	...
	@NamedQuery(name = AuthorityEntity.DEF_FIND_AUTHORITIES_BY_IDS,  query = "SELECT g FROM AuthorityEntity g WHERE g.id in (:ids)")
	})
...
public class AuthorityEntity extends BaseEntity {
	...
	public static final String DEF_FIND_AUTHORITIES_BY_IDS = "findAuthorities_ByIds";
	...
	public String getNamedQueryFindByIds() {
		return DEF_FIND_AUTHORITIES_BY_IDS;
	}
