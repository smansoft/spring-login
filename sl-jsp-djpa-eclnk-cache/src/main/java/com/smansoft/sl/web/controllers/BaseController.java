...
public class BaseController {
	...
	public static final String DEF_ROOT_HTM = "/";
	
	public static final String DEF_INDEX_HTM = "/index.htm";

	public static final String DEF_LOGIN_HTM = "/login.htm";

	public static final String DEF_LOGOUT_HTM = "/logout.htm";
	...
	public static final String DEF_USERS_LIST_JSON = "/users/list.json";
