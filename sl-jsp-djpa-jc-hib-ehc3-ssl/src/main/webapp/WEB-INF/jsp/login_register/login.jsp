...
<div class="page-login">
	<div class="form-login">
		<form:form id="login-form-id" class="login-form" modelAttribute="userVO" method="post" action="login.htm">
			...
			<p class="message">Not registered? <a href='<c:url value="/register.htm"/>'>Create an account</a></p>
		</form:form>
	</div>
</div>
